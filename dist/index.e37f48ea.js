...
/* API KEY:9bd96907-1584-4479-850a-72eeb377c6f1 */ // import icons from '../img/icons.svg';
...
const showRecipe = async function() {
    try {
        ...
        if (!response.ok) throw new Error(`${response.ok} and ${response.status}`);
